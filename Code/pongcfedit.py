...
def main():
    ...
    RUNNING, PAUSE = 0, 1
    state = RUNNING
    pause_text = pygame.font.Font('freesansbold.ttf', BASICFONTSIZE).render('Paused. Press o to unpause.', True, pygame.color.Color('White'))
    ...
    while True: #main game loop
        ...
        if state == RUNNING:
            ...
            DISPLAYSURF.blit(pause_text, (13, 100))
